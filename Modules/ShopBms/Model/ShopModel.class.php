...
class ShopModel extends BmsBaseModel
{
    ...
    function findRow($param = array()) {
        return $this->alias('shop')
            ->field('shop.id,shop.name,shop.contacts,shop.status,shop.mobile,shop.area_id,shop.address,shop.short,shop.area_id,shop.create_time,shop.update_time,shop.logo,shop.sort,shop.keywords')
            ->where($param['where'])
            ->join(array())
            ->find();
    }
