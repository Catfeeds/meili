...
class BespeakTimeModel extends BmsBaseModel
{
    ...
    function getList($param = array()) {
        ...
        $list  = $this->alias('bespeaktime')
            ->where($param['where'])
            ->field('bespeaktime.id,bespeaktime.name,bespeaktime.create_time,bespeaktime.update_time,bespeaktime.start_time,bespeaktime.end_time,bespeaktime.status')
            ->select();
    ...
    function findRow($param = array()) {
        return $this->alias('bespeaktime')
            ->field('bespeaktime.id,bespeaktime.name,bespeaktime.start_time,bespeaktime.end_time')
            ->where($param['where'])
            ->find();
    }
}