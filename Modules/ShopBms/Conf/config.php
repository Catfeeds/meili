 ...
 */
//常量
define('TERMINAL', 'shopbms');
//配置
return array(
    /* 模板相关配置 */
    'TMPL_PARSE_STRING' => array(
        '__STATIC__'    => __ROOT__ . '/Public/Static',
        '__IMG__'       => __ROOT__ . '/Public/Bms/img',
        '__CSS__'       => __ROOT__ . '/Public/Bms/css',
        '__JS__'        => __ROOT__ . '/Public/Bms/js',
    ),

    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'sx2016_shopbms', //session前缀
    'COOKIE_PREFIX'  => 'sx2016_shopbms_', // Cookie前缀 避免冲突
    ...
    'NOW_HOST' => 'http://meili-shop-bms.meili.com/',
    'POSITION_AD'=>array(
        '1'=>'商城轮播',
        '2'=>'首页轮播',
    ),
