...
class OrderInfoSerModel extends BmsBaseModel
{
    /**
     * @var array
     * 自动验证规则
    ...
    public function getList($param = array()) {
        ...
        //获取数据
        $list   = $this->alias('oi')
            ->field('oi.id,oi.order_sn,oi.m_id,oi.consignee,oi.mobile,oi.integral_ded_amounts,oi.flag,
    ...
    function findRow($param = array()) {
        return $this->alias('oi')
            ->field('oi.id,oi.order_sn,oi.consignee,oi.mobile,oi.integral_ded_amounts,oi.flag,oi.flag_id,
