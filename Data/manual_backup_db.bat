...
D:\wamp\bin\mysql\mysql5.6.12\bin\mysqldump --default-character-set=utf8 --opt --extended-insert=false -R --hex-blob -x -q yds_wash {{tables}} > D:\wamp\www\wash.toocms-project.com\Data\data\%Ymdhis%.sql
rem 压缩命令 执行压缩
